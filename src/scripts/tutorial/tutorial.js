...
export const runTutorial = function () {
	...
	function forcesSequence() {
		...
		msg =
			"<p> Here you can assign the environment properties, such as surface gravity, which will affect objects' gravitational acceleration. </p>";
		let forcesMessage = new TutorialMessage(msg, "div", forcesDiv, {
			x: "-650px",
			y: "120px",
		});
		function forcesLoop() {
	...
	function controlsSequence() {
		...
		let controlsMessage = new TutorialMessage(msg, "div", controlsDiv, {
			x: "0px",
			y: "70px",
		});
	...
	function demosSequence() {
		...
		msg =
			"<p> Here you can begin preset scenarios, clearing all objects beforehand. After those preconditions are created you can manipulate the environment and objects as normal.</p>";
		let demosMessage = new TutorialMessage(msg, "div", demosDiv, {
			x: "-640px",
			y: "70px",
		});
		function demosLoop() {
	...
	function finalSequence() {
		msg =
			"<p>Click to place an object with the properties you selected at the cursor. Observe as it reacts to the environmental forces and its fellow objects.</p>";
		let finalMessage = new TutorialMessage(msg, "div", controlsDiv, {
			x: "170px",
			y: "300px",
		});
